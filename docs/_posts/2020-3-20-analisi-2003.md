...
<!--more-->
[![Dati Lombardia]({{ site.baseurl }}/images/lombardia.png)]({{ site.baseurl }}/images/lombardia.png)

## Dati per provincia
[![Nuovi Contagiati]({{ site.baseurl }}/images/incrementi.png)]({{ site.baseurl }}/images/incrementi.png)

[![Contagiati Totali]({{ site.baseurl }}/images/totale.png)]({{ site.baseurl }}/images/totale.png)

[![Tasso crescita]({{ site.baseurl }}/images/tasso.png)]({{ site.baseurl }}/images/tasso.png)
